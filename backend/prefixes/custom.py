from constants import (BEAT_ELEMENT, CHARACTER_MARKER, CHARACTERS_ELEMENT, DESCRIPTION_ELEMENT, DESCRIPTION_MARKER,
                       DIALOG_MARKER, END_MARKER, LOGLINE_ELEMENT, LOGLINE_MARKER, PLOT_ELEMENT, PLACE_ELEMENT, PREVIOUS_ELEMENT,
